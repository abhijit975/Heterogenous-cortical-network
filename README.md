...
2. balanced_heterogeneous.cpp - Produces firing statistics for perfectly balanced network with heterogeneous cluster sizes. -- **To be uploaded**
...
4. hierarchy.cpp - Produces a partially balanced network with hierarchy. -- **To be uploaded**
